...
class UserSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $unit_hotel_harmony_id = DB::table('units')->where('nama_unit', 'HOTEL HARMONY')->value('id');
        $unit_guesthouse_ruma_id = DB::table('units')->where('nama_unit', 'GUESTHOUSE RUMA')->value('id');
        $unit_hotel_gallery_id = DB::table('units')->where('nama_unit', 'HOTEL GALERY')->value('id');
